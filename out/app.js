...
var crypto_compare_OHLC_1 = require("./crypto-compare-OHLC");
    ...
    App.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                heloc = new crypto_compare_OHLC_1.HLOC();
                heloc.DailyHLOC('ETH', 'USD', 2, new Date('11/25/2020')).then(function (res) {
                    var input = {
                        open: [],
                        high: [],
                        close: [],
                    ...
                    var result = technicalindicators_1.eveningdojistar(input);
